...
def generate_dummy_data(num_entries):
    ...
    for x in range(num_entries):
        ...
        random_timestamp=datetime.datetime(2023,9,random.randint(1,4),random.randint(0,23),random.randint(0,59),random.randint(0,59))  #int in a given range
...
if __name__ == "__main__":
    ...
    clean_database()
    new_data=generate_dummy_data(100)
